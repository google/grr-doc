...
* *Note* `approval_cc_address` should be within the configured domain. This means if
your email domain is configured to `localhost`, and you want the email to go to
`alerts@localhost` you should put `Email.approval_cc_address: alerts`
