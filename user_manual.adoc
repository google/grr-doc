...
----
~/grr/tools# python import_nsrl_hashes.py --config /etc/grr/grr-server.yaml --secondary_configs /etc/grr/server.local.yaml --filename /media/<path to expanded NSRL>/NSRLFile.txt
