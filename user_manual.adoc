...
and on OS X:
---------------------------------------------------------------------
/Users/alice/blah.txt, /Users/bob/blah.txt, /Users/eve/blah.txt
---------------------------------------------------------------------

and on Linux:
---------------------------------------------------------------------
/home/alice/blah.txt, /usr/local/home/bob/blah.txt, /home/local/eve/blah.txt
---------------------------------------------------------------------

A full list of possible interpolation values can be found by typing %% in the
gui.  The canonical reference is the link:https://code.google.com/p/grr/source/browse/proto/knowledge_base.proto[proto/knowledge_base.proto] file, which also contains docstrings for each type.
...
RegistryFinder will retrieve the values of any keys specified.
...
across systems.  We have built a framework to describe forensic artifacts that
allows them to be collected and customised quickly using GRR.
link:https://code.google.com/p/grr/source/browse/artifacts[The collection of
artifacts] is intended to be a centralized, free, community sourced, knowledge
base of forensic artifacts that the world can use both as an information source
...
link:artifact_yaml_style.adoc[available here].  We use a standard set of machine
information collected from the host for variable interpolation.  This collection
of data is called the Knowledge Base (see
link:https://code.google.com/p/grr/source/browse/proto/knowledge_base.proto[proto/knowledge_base.proto])
and is referenced with a %%variable%% syntax.

The artifact defines where the data lives.  Once it is retrieved by GRR a
link:https://code.google.com/p/grr/source/browse/parsers[parser] can optionally
...
New artifacts can be added to the link:https://code.google.com/p/grr/source/browse/artifacts[grr/artifacts] directory, which will be
imported on server restart.  Artifacts can also be uploaded via the Artifact
Manager gui and used immediately without the need for a restart.
