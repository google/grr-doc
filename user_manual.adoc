...
- Additionally, when you run a hunt you can specify a "Client Rate". This number  
sets the maximum number of clients to engage per minute. A rate of 0 means to
schedule clients as fast as possible. This can be used as a way of limiting how
fast load on the system ramps up. If this is set low, you can expect a very 
slow hunt. 
