...
Once you have your vagrant VMs setup, build installers for all OSes just by
running make. Note that if you're building for OS X, you'll probably run this
once on linux and once on apple hardware.
