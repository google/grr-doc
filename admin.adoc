...
auditing capabilities through the API router. 

Setting API.DefaultRouter configuration router to
an API router that will be doing necessary access checks allows for sensible
access control. I.e. another user must authorize
...
This is visible in the Admin UI under Administrative flows if Advanced
Mode is enabled.
