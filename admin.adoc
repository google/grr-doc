...
Note that we want to run this as a dockerhub build on every commit, but are link:https://github.com/docker/hub-feedback/issues/292[blocked by dockerhub's inability to separate context and Dockerfile].
