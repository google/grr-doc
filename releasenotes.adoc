...
=== 0.3.0-7 to 0.3.0-8 (unreleased)
 ...
 - *INFO* Config option Cron.enabled_system_jobs (a whitelist) was replaced with Cron.disabled_system_jobs (a blacklist) to make adding new cronjobs easier. If you customized that list at all you'll have to translate it to the new list.
 ...
 * Cron.enabled_system_jobs (a whitelist) was replaced with Cron.disabled_system_jobs (a blacklist)
